...
public class DecryptTests {
    ...
    public void callTest() throws Exception {
        ...
        String imgPath1 = cachePath + File.separator + "Disk1" + File.separator + "wx_camera_1678246623824.jpg.ori.webp";
        String imgPath2 = cachePath + File.separator + "Disk2" + File.separator + "wx_camera_1678246623824.jpg.ori.webp";

...
public class HttpUtils {
     ...
     * 单向验证
     */
    public static SSLSocketFactory getSslSocketFactorySingle(InputStream... certificates) {
        SSLContext sslContext = null;
        try {
            CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
            KeyStore keyStore = KeyStore.getInstance(KeyStore.getDefaultType());
     ...
     * 双向验证
     */
    public static SSLSocketFactory getSslSocketFactoryDouble(Context context, InputStream... certificates) {
        try {
            CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
            KeyStore keyStore = KeyStore.getInstance(KeyStore.getDefaultType());
            keyStore.load(null);

...
public class StatusBarUtil {
    ...
    public static void setLightMode(Activity activity) {
        setMIUIStatusBarFont(activity, true);
        setMeizuStatusBarFont(activity, true);
        setDefaultStatusBarFont(activity,true);
    }

    @TargetApi(Build.VERSION_CODES.M)
    public static void setDarkMode(Activity activity) {
        setMIUIStatusBarFont(activity, false);
        setMeizuStatusBarFont(activity, false);
        setDefaultStatusBarFont(activity,false);
    }

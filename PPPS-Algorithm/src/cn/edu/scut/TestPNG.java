...
//                System.out.println(((r1 + r2) % 256) + ", " + ((g1 + g2) % 256) + ", " + ((b1 + b2) % 256));
        ...
        try {
            ImageIO.write(bi1, "png", new File(image1));
            ImageIO.write(bi2, "png", new File(image2));
        } catch (IOException e) {
        ...
        try {
            ImageIO.write(bi3, "png", new File(newfile));
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public static void genThumbnail(String origin, String newfile, int size) {
        ...
        try {
            ImageIO.write(bi1, "png", new File(newfile));
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
...
//    					" " + ncord[1][x / 15][y / 15]);
        ...
        try {
            ImageIO.write(image3, "png", new File(newfile));
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public static void main(String [] args){
        ...
        int[][][] record = getImagePixel("images/ZHAO.jpg", "images//zbw1.png", "images//zbw2.png");

        genThumbnail("images/ZHAO.jpg", "images/ZHAO_thumbnail.png", 15);
        genThumbnail("images/zbw1.png", "images/zbw1_thumbnail.png", 15);
